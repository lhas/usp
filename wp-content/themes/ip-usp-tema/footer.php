...
<script src="<?php echo get_template_directory_uri(); ?>/bower_components/list.js/dist/list.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/bower_components/imgLiquid/js/imgLiquid-min.js"></script>
